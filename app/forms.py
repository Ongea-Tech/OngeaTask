...
class SignUpForm(FlaskForm):
    ...
    password = PasswordField('Password*', validators=[DataRequired(message="Password is required."), Length(min=6, max=100, message="Password must be between 6 and 100 characters.")])
    confirm_password = PasswordField('Confirm Password*', validators=[DataRequired(message="Please confirm your password."), Length(min=6, max=100, message="Password must be between 6 and 100 characters.")])
